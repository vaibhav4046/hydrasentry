...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/A00_idle_landing.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B00_results_run.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B01_graph_tainted.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B03_skillmake_critical.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B04_mcp.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B02_replay.jpg}
...
\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B05_scheduled.jpg}
\caption{Scheduled agents: an in-app simulated schedule, labelled as simulated; no real cron is registered.}\end{figure}

\begin{figure}[h]\centering\includegraphics[width=0.9\linewidth]{assets/B06_mission.jpg}
...
\begin{enumerate}
\item Documentation de-staling: removed stale ``no live deployment'' claims; added live URLs near the top of README, DEMO, SUBMISSION, DEV_NOTES; reconciled the Constellan/hydrasentry naming; neutralised the SSO-gated vanity host.
